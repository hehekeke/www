    ...
    <div class="pro_content clearfix area" id="top">
        ...
        <div class="pro_right fr">
            <div class="pro_right_top mb10 clearfix">
                <h3 class="fl">抢元宝</h3>
                <a href="http://yuntv.letv.com/bcloud.swf?uu=26a8cba9e6&vu=c95fcfd4e3&auto_play=1&gpcflag=1" class="fr">产品视频</a>
                <a data-href="http://mp.weixin.qq.com/s?__biz=MjM5OTM2OTYwMQ==&mid=202996231&idx=1&sn=6c995241cde0f9835b67611a1401c4d0#rd" class="fr qrcode">码上体验</a>
            </div>
            <div class="pro_right_main">
                <div class="tc"><img src="/data/images/25/201502/b0c82b3a65dd33ae190b8fb9f37d7193.png" alt="抢元宝"></div>
                <div><p>    <p>
                        契合过年气氛的互动应用，会吸粉的元宝，让吸粉变简单！
                    </p>
                    <p>
                        点击“码上体验“扫码体验或微信关注“wxsyb88”回复“<span style="color:#FFFFFF;background-color:#E53333;"><strong>抢元宝</strong></span>”体验
                    </p></p></div>
            </div>
        </div>
    </div>
