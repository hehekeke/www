    ...
    <div class="pro_content clearfix area" id="top">
        <div id="side_nemu" class="side_nemu fl">
            <ul>
                ...
                <li class='on'><div class="option_hd">互动型</div>
        ...
        <div class="pro_right fr">
            <div class="pro_right_top mb10 clearfix">
                <h3 class="fl">微测试</h3>
                <a href="http://yuntv.letv.com/bcloud.html?uu=26a8cba9e6&vu=47c2ca0834&auto_play=1&gpcflag=1&width=640&height=360" class="fr">产品视频</a>
                <a data-href="http://t.cn/R78GMQz" class="fr qrcode">码上体验</a>
            </div>
            <div class="pro_right_main">
                <div class="tc"><img src="http://www.weiba66.com/data/images/1/201410/557d24a64c5ba2b751ffd8808f180c8f.png" alt="微测试"></div>
                <div><p>    <p>
                        一款以测试为题材的娱乐小游戏，<span style="line-height:1.5;">玩家在游戏中输入名字即可得到测试结果，</span><span style="line-height:1.5;">可以测试自己也可以测试别人。</span>
                    </p>
                    <p>
                        <strong>优势：</strong>趣味性的设置让玩家测试后分享到朋友圈或分享给好友而形成传播效益。
                    </p>
                    <p>
                        点击“码上体验”扫码体验或微信关注“nuohuikejic”回复“<span style="background-color:#E53333;color:#FFFFFF;"><strong>微测试</strong></span>”体验
                    </p></p></div>
            </div>
        </div>
    </div>
