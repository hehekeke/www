    ...
    <div class="pro_content clearfix area" id="top">
        <div id="side_nemu" class="side_nemu fl">
            <ul>
                ...
                <li class='on'><div class="option_zs">展示型</div>
        ...
        <div class="pro_right fr">
            <div class="pro_right_top mb10 clearfix">
                <h3 class="fl">微名片</h3>
                <a href="http://yuntv.letv.com/bcloud.html?uu=26a8cba9e6&vu=22bb792aaa&auto_play=1&gpcflag=1&width=640&height=360" class="fr">产品视频</a>
                <a data-href="http://t.cn/R78uYmQ" class="fr qrcode">码上体验</a>
            </div>
            <div class="pro_right_main">
                <div class="tc"><img src="http://www.weiba66.com/data/images/1/201410/67b170a15c0ee812cfc213ab3f7f434d.png" alt="微名片"></div>
                <div><p>    <p>
                        在微时代，要让人记住就必须推陈出新，做到真正的与众不同！
                    </p>
                    <p>
                        给您不一样的多重选择，打造属于您的独一无二微名片！
                    </p>
                    <p>
                        点击“码上体验“扫码体验或微信关注“wxsyb88”回复“<span><span style="background-color:#E53333;color:#FFFFFF;"><strong>名片 小微</strong></span></span>”体验
                    </p></p></div>
            </div>
        </div>
    </div>
