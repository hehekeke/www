...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
   ...
   <body class="home">
   <?php include_once("head_nav.html"); ?>
         ...
         <footer id="footer">
                     ...
                     <section class="col-lg-3 col-md-3 col-xs-12 col-sm-3 footer-three">
                        ...
                        <ul class="contact-us">
                           <li>
                              ...
                              <p> 
                                 <strong>地址:</strong> 250 Sher-E- Bangla Road, <br>
                                 Khulna, Bangladesh 
                              </p>
                           </li>
                           <li>
                              <i class="icon-phone"></i>
                              <p><strong>电话:</strong> +189 20 766 688</p>
                           </li>
                           <li>
                              <i class="icon-envelope"></i>
                              <p><strong>邮箱:</strong><a href="mailto:info@fifothemes.com">18920766688@163.com</a></p>
                           </li>
                        </ul>
                     </section>
            ...
            <div class="footer-bottom">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 ">Copyright &copy; 2014.Company name All rights reserved.<a target="_blank" href="http://www.moke8.com/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></div>
